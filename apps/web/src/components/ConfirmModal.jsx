...
export function ConfirmModal({ open, message, confirmLabel = "Confirmar", onConfirm, onCancel }) {
  useEffect(() => {
...
export function useConfirm() {
  ...
  const confirm = useCallback((message, confirmLabel = "Confirmar") => {
  ...
  function close(value) {
    setState((prev) => {
      prev.resolve?.(value);
      return { open: false, message: "", confirmLabel: "Confirmar", resolve: null };
    });
  }
